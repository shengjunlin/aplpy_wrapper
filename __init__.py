...
if aplpy.version.major != 1:
    print("\x1b[0;31;40m"+"aplpy_wrapper only partially works with APLpy 2 and the old APLpy 0 version. Some functionality will raise unsolvable errors."+"\x1b[0m")

import pyregion
if pyregion.version.major != 1:
    print("\x1b[0;31;40m"+"aplpy_wrapper only partially works with pyregion 2. Some functionality will raise unsolvable errors."+"\x1b[0m")
