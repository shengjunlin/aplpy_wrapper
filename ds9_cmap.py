...
# Description : This script registers the "turbo" colormap to matplotlib, and the reversed version as "turbo_r"
...
register_cmap(name='turbo_r', data=mpl_data_r, lut=turbo_colormap_data.shape[0])
